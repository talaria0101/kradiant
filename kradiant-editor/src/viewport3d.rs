...
impl Viewport3D {
    pub fn new(line_vertices: Vec<Vec3>, tri_vertices: Vec<LitVertex>, fbo: glow::Framebuffer, fbo_size: [u32; 2], tex: glow::Texture, rbo: glow::Renderbuffer, cache: Option<View3dCache>) -> Self
    {
        Self {
            line_vertices,
            tri_vertices,
